# Lazy-loading Testkit for Kirby

To use this project, you have to add the `kirby` core folder using Composer (`composer require getkirby/cms`) or by (link: https://github.com/getkirby/kirby/archive/refs/heads/main.zip text: downloading it).
